                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-custom table-lg mb-0" id="products">
                                ...
                                <tbody>
                                    ...
                                    ?>  -->
                                    <td class="text-end"> <a href="{{ route('admin.editcategory', $categorie) }}">Edit</a></td>
                                    <td class="text-end">
                                        <form action="{{ route('admin.destroycategory', $categorie) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" style="background:initial; border:none" >Delete</button>
                                        </form>    
                                    </td>
                                </tbody>
                                @endforeach
