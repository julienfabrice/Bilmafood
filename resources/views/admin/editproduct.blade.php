                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="price" type="number" class="form-control" value="{{ $product->stock }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @if ($product->main_image)
                                                    <img src="{{ Storage::url($product->main_image) }}" width="100">
                                                @endif
                                            </div>
                                            <div class="mb-3">
                                                <label for="other_images" class="form-label">Autres images :</label>
                                                <input class="form-control" type="file" id="other_images" name="other_images[]" accept="image/*" multiple>
