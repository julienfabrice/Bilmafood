...
<!-- <div class="tbloading-bg tbloader"></div> -->
	<div id="page">
                                                            ...
                                                            <form action="" class="language-picker__form">
                                                                ...
                                                                <div class="custom-select-wrapper">
                                                                    <select name="language-picker-select" id="language-picker-select" >
                                                                        <option lang="en" value="en-gb" data-image="catalog/language/en-gb/en-gb.png"selected data-key="header.selecten">English</option>
                                                                        <option lang="fr" value="fr-fr" data-image="catalog/language/fr-fr/fr-fr.png"  data-key="header.selectfr">French</option>
		        ...
		        <div id="slideshow0" class="swiper-container clearfix">
			        <div class="swiper-wrapper">
						<div class="swiper-slide text-center Slider-01">
							...
							<div class="slider-description"><div class="tb-slider-title">It's Fruit Madness</div>
		                    <div class="tb-slider-slider-button"><a href="#" class="btn-secondary">Shop Now</a></div></div>
				        </div>
						<div class="swiper-slide text-center Slider-02">
							...
							<div class="slider-description"><div class="tb-slider-title">Test of the Delicious</div>
		...
		<div class="tb-home-bg">
			<div class="tb-home">	
				<div id="content" class="col-lg-12">
		            ...
		            <div class="html-content">
			            <div class="box-content"><div id="tb-services-cms">
				            <div class="container">
		...
		<div class="html-content">
			<div class="box-content"><div id="tb-sub-banner-cms" class="sub-banner">
				<div class="container">
					<div class="row"> 
		...
		<div class="TB-Commen-Heading"><h3>Categories Products</h3></div>
		<div class="categoryslider-content">
		<div class="tbcat-tab">
			
			<div id="TBCTab-" class="tab-box-heading">
				<ul class="nav nav-tabs">
																						<li  class="active"><a href="#tab-1" data-toggle="tab"><h3 class="tab-title">Orange Jam</h3></a></li>
																						<li ><a href="#tab-2" data-toggle="tab"><h3 class="tab-title">Mango Jam</h3></a></li>
																						<li ><a href="#tab-3" data-toggle="tab"><h3 class="tab-title">Mixed Fruit</h3></a></li>
								</ul>
			</div>
		</div>
		...
		<div class="html-content">
			<div class="box-content"><div id="tb-testimonial-cms" class="parallex">
				<div class="container">
