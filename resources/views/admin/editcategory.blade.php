...
<body>
    ...
    <div class="layout-wrapper">
        ...
        <div class="header">
            ...
            <form method="post" action="{{ route('admin.updatecategory', $categorie) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" type="text" value="{{ old('name', $categorie->name) }}" class="form-control" required>
                                            </div>
                                        </div>
                            ...
                            <ul class="nav nav-pills flex-column gap-2" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    ...
                                    aria-controls="password" aria-selected="false">
                                        <i class="bi bi-lock me-2"></i> Catégorie produit
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
