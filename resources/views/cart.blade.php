                                    ...
                                    @foreach (Session::get('cart', []) as $productId => $item)
                                        <tr>
                                            <td class="text-center">                                            
                                                <img src="{{ Storage::url($item['main_image']) }}" title="{{ $item['name'] }}" class="img-thumbnail" />                                                                                               
                                            </td>
                                            <td class="text-left"><a href="#">{{ $item['name'] }}</a>
                                            </td>
                                            <td class="text-left">
                                                <div class="cart_input_block input-group btn-block" style="max-width: 200px;">
                                                    <input type="text" name="quantity" value="{{ $item['quantity'] }}" size="1" class="form-control quantity-input" style="height: 45px;"/>
                                                    <span class="input-group-btn">
                                                        <button type="submit" data-toggle="tooltip" title="Update" class="btn btn-primary main update-quantity" style="width: 49px; height: 45px; padding:0" data-product-id="{{ $productId }}">
                                                            <i class="icofont-refresh"></i>
                                                        </button>
                                                        <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger remove_card" style="width: 49px; height: 45px;" data-product-id="{{ $productId }}">
                                                            <i class="icofont-close"></i>
                                                        </button>
                                                    </span>
                                                </div>
                                            </td>
                                            <td class="text-right unit-price"> {{ $item['price'] }} </td>
                                            <td class="text-right total-price">{{ $item['price'] * $item['quantity'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="col-sm-4 sub-total-table">
                            ...
                            @endforeach
                                ...
                                <tr>
                                    ...
                                    <td class="text-right total-amount">cfa {{ $total }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
