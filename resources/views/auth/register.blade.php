		...
		<div id="account-register" class="container">
			...
			<div class="row">
				<div id="content" class="col-sm-12">
					...
					<form method="POST" action="{{ route('client.register') }}" class="form-horizontal">
						@csrf
						<fieldset id="account">
						...
						<fieldset>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="password" name="password_confirmation" placeholder="Password Confirm" id="input-confirm" class="form-control" />
