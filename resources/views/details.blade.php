...
<!-- Mirrored from templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/index.php?route=product/product&path=65&product_id=43&sort=p.price&order=DESC by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 May 2024 03:48:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Natural Jam Bitter Orange</title>
    <base  />
    ...
    <link href="{{ asset('catalog/view/javascript/jquery/magnific/magnific-popup.css.tmp') }}" type="text/css" rel="stylesheet" media="screen" />
    ...
    <link href="indexb8ca.html?route=product/product&amp;product_id=43" rel="canonical" />
...
<div id="product-product" class="container product-product">
  <ul class="breadcrumb">
        <li><a href="index9328.html?route=common/home"><i class="icofont-home"></i></a></li>
        <li><a href="indexc6e5.html?route=product/category&amp;path=65&amp;sort=p.price&amp;order=DESC">Berryblast </a></li>
        <li><a href="index00fb.html?route=product/product&amp;path=65&amp;sort=p.price&amp;order=DESC&amp;product_id=43">Natural Jam Bitter Orange</a></li>
      </ul>
  <div class="row">
                <div id="content" class="col-lg-12">
	
	<h1 class="page-title">Natural Jam Bitter Orange </h1>
	  <!-- Product row START -->
      <div class="row">
          ...
          <div class="thumbnails">
			  ...
			  <a class="thumbnail" title="Natural Jam Bitter Orange">
			  <img  onmousemove="zoom(event)" class="zoo-img" src="{{ asset('image/cache/catalog/demo/product/11-870x1140.jpg') }}" title="Natural Jam Bitter Orange" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/11-870x1140.jpg" alt="Natural Jam Bitter Orange" />
			  			  </a>
			</div>
		...
		<div class="additional-images-container">
			...
			<img src="{{ asset('image/cache/catalog/demo/product/11-870x1140.jpg') }}" title="Natural Jam Bitter Orange" data-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/11-870x1140.jpg" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/11-870x1140.jpg" alt="Natural Jam Bitter Orange" />
			</div>
			   				 <div class="image-additional"> 
					<img src="{{ asset('image/cache/catalog/demo/product/11-02-110x144.') }}jpg" title="Natural Jam Bitter Orange" data-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/11-02-870x1140.jpg" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/11-02-870x1140.jpg" alt="Natural Jam Bitter Orange" />
				</div>
			   				 <div class="image-additional"> 
					<img src="{{ asset('image/cache/catalog/demo/product/17-110x144.jpg') }}" title="Natural Jam Bitter Orange" data-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/17-870x1140.jpg" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/17-870x1140.jpg" alt="Natural Jam Bitter Orange" />
				</div>
			   				 <div class="image-additional"> 
					<img src="{{ asset('image/cache/catalog/demo/product/06-02-110x144.') }}jpg" title="Natural Jam Bitter Orange" data-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/06-02-870x1140.jpg" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/06-02-870x1140.jpg" alt="Natural Jam Bitter Orange" />
				</div>
			   				 <div class="image-additional"> 
					<img src="{{ asset('image/cache/catalog/demo/product/08-02-110x144.') }}jpg" title="Natural Jam Bitter Orange" data-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/08-02-870x1140.jpg" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/08-02-870x1140.jpg" alt="Natural Jam Bitter Orange" />
				</div>
			   				 <div class="image-additional"> 
					<img src="{{ asset('image/cache/catalog/demo/product/01-110x144.jpg') }}" title="Natural Jam Bitter Orange" data-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/01-870x1140.jpg" data-zoom-image="https://templatebunch.com/Opencart/OPC005/OPCTB49/OPC01/image/cache/catalog/demo/product/01-870x1140.jpg" alt="Natural Jam Bitter Orange" />
				</div>
			   			</div>
			 		</div>
		...
		<h1 class="product-name">Natural Jam Bitter Orange</h1>
		
		<table class="product-info">
                        <tr><td>Brand:</td><td class="product-info-value"><a href="index98fa.html?route=product/manufacturer/info&amp;manufacturer_id=8">Apple</a></td></tr>
                        <tr><td>Product Code:</td><td class="product-info-value">Product 16</td></tr>
                        <tr><td>Reward Points:</td><td class="product-info-value">600</td></tr>
		  ...
		  <i class="icofont-comment"></i>0 reviews</a>
			<a class="product-write-review" href="#" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">
			<i class="icofont-ui-edit"></i>Write a review</a>
		  </div>
          		  <!-- Product Rating END -->
              ...
              <h2>$602.00</h2>
            			            ...
            			            <li class="product-tax">Ex Tax: $500.00</li>
          ...
          <div class="btn-group">
            <button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('43');"><i class="icofont-heart"></i>
			Add to Wish List 
			</button> 
            <button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('43');"><i class="icofont-signal"></i>
			Add to compare
			</button>
          </div>
		  <!-- Product Wishlist Compare END -->
            ...
            <div class="addthis_toolbox addthis_default_style" data-url="indexb8ca.html?route=product/product&amp;product_id=43"><a class="addthis_button_facebook_like" fb:like:layout="button_count"></a> <a class="addthis_button_tweet"></a> <a class="addthis_button_pinterest_pinit"></a> <a class="addthis_counter addthis_pill_style"></a></div>
