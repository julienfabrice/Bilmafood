      ...
      <div class="row">
        ...
        <div id="content" class="col-lg-9">
          ...
          <div class="category-description">
            <div class="row">
              <div class="col-lg-3 category-image">
              ...
              <div class="block-description col-lg-9">
                <div class="category-content">
                  <p>Aliquam egestas porta nulla, a feugiat dolor auctor ac. Ut ultrices interdum nunc, a suscipit sapien lacinia sed.</p>
                  <p> Etiam eget tellus nisl. Etiam sit amet feugiat eros, vel pharetra neque. Ut a posuere. Aenean interdum hendrerit augue, ut vehicula metus placerat nec.</p>
                  <p> Donec sollicitudin pellentesque hendrerit. Etiam luctus orci eu ligula pharetra, ac pulvinar orci malesuada. Quisque elementum posuere.</p>
                </div>
          ...
          <div class="category-pagination">
            ...
            <div class="col-xs-6 text-right">
              <ul class="pagination">
                ...
                <li><a href="index9be6.html?route=product/category&amp;path=65_81&amp;sort=p.price&amp;order=DESC&amp;page=2">2</a></li>
                <li><a href="index9be6.html?route=product/category&amp;path=65_81&amp;sort=p.price&amp;order=DESC&amp;page=2">&gt;</a></li>
                <li><a href="index9be6.html?route=product/category&amp;path=65_81&amp;sort=p.price&amp;order=DESC&amp;page=2">&gt;|</a></li>
              </ul>
            </div>
          </div>
